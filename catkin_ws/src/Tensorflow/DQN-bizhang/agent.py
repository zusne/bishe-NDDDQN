...
class DQNAgent:
    ...
    def __init__(self,
        ...
        self._error_op, self._train_op = self._get_error_and_train_op(self._reward_ph,
                                                                      ...
                                                                      self._action1_ph,
                                                                      self._action2_ph,
                                                                      self._action1_chosen_by_target_ph,
                                                                      self._action2_chosen_by_target_ph)
    ...
    def _get_error_and_train_op(self,
                                ...
                                action1_ph,
                                action2_ph,
                                action1_chosen_by_target_ph,
                                action2_chosen_by_target_ph):
        """Train the network"""
        ...
        error_op = error_op1 * 0.5 + error_op2 * 0.5
    ...
    def evaluate(self, sess, env):
        ...
        while num_finished_episode < 5:
            ...
            next_action1, next_action2 = self.select_action(sess, new_state, self._online_model)
    ...
    def fit(self, sess, env, num_iterations, do_train=True):
        ...
        for t in range(num_iterations):
            ...
            if do_train:
                ...
                action1_chosen_by_target, action2_chosen_by_target = sess.run([self._target_model['action1'], self._target_model['action2']], feed_dict={self._target_model['input_frames']: new_state_list.astype(np.float32)})
