...
#conv3:null,10,13,32
    ...
    outputB, parameter_list_outputB = direct_net(flat_output4,name='fcB',input_size=int(flat_output4_size), output_size=50, trainable=trainable,
                                                 activation_fn=tf.nn.relu)
    outputB1, parameter_list_outputB1 = direct_net(outputB,name='fcB1',input_size=50, output_size=128, trainable=trainable,
                                                 activation_fn=tf.nn.relu)
    output_last=tf.concat([flat_output3,outputB1],1)
    flatten_shape = flat_output3_size+128
    ...
    return output_last, flatten_shape,parameter_list
