...
class GazeboWorld():
    def __init__(self, ns='',
        ...
        self.goal_position.point.y = -3.
        self.goal_position.point.z = 0.
        self.goal_table=[(4,-3),(4,3),(-4,3),(-4,-3)]
        self.old_distance=0.
        self.old_angle=0.
    ...
    def setGoal(self):
        ...
        self.goal_position.point.x = goal[0]
        self.goal_position.point.y = goal[1]
        print('new goal:')
    ...
    def GetRewardAndTerminate(self):
        ...
        reward = 2*v * v * np.cos(2 * v * theta)+reward_distance+reward_angle
        if self.GetBump():
            reward = -10.
            terminate = True
            reset = True
    ...
    def GetReward_Angle(self,new_angle,old_angle):
        ...
        reward_angle=0
        if abs(new_angle)<abs(old_angle):
            reward_angle=0.1
        elif abs(new_angle)>abs(old_angle):
            reward_angle=-0.1
        else:
            reward_angle=0
        return reward_angle
