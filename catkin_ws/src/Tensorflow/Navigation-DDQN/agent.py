...
#DQN:
#       self._action1_chosen_by_target_ph = tf.placeholder(tf.int32, [None, 2], name='action1_chosen_by_online_ph')
#       self._action2_chosen_by_target_ph = tf.placeholder(tf.int32, [None, 2], name='action2_chosen_by_online_ph')
...
#               feed_dict[self._action2_chosen_by_target_ph] = list(enumerate(action2_chosen_by_target))
                ...
                self._e.append(sess.run(self._error_op, feed_dict=feed_dict))
